...
public class GameRepository
{
    ...
    private readonly IMongoCollection<PlayerClass> _classes;

    public GameRepository()
    {
        var client = new MongoClient("mongodb://localhost:27017");
        _db = client.GetDatabase("KalleLindberg");
        _classes = _db.GetCollection<PlayerClass>("PlayerClasses");
    }
    ...
    public async Task SeedClassesAsync()
    {
        ...
        {
            new PlayerClass { Name = "Warrior", StartHp = 120, Symbol = '@' },
            new PlayerClass { Name = "Wizard",  StartHp = 80,  Symbol = '@' },
            new PlayerClass { Name = "Thief",   StartHp = 100, Symbol = '@' }
        });
    }
